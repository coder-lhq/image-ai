...
export const Toolbar = ({ editor, activeTool, onChangeActiveTool }: ToolbarProps) => {
    ...
    if (editor?.selectedObjects.length === 0) {
      return (
        <div className="shrink-0 h-[56] border-b bg-white w-full flex items-center overflow-x-auto z-49 p-2 gap-x-2"> </div>
      )
    }
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Bold" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.fontWeight > 500 && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Italic" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.fontStyle === "italic" && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Underline" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.fontUnderline && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Strike" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.fontLinethrough && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Align left" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.textAlign === "left" && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Align center" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.textAlign === "center" && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Align right" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(properties.textAlign === "right" && "bg-gray-100")
                    }
                  >
              ...
              <div className="flex items-center h-full justify-center">
                <Hint label="Filters" side="bottom" sideOffset={5}>
                  <Button
                    ...
                    variant="ghost"
                    className={
                      cn(activeTool === "filter" && "bg-gray-100")
                    }
                  >
